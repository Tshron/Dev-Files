...
namespace FacebookAppUI
{
    public partial class Login
    {
        ...
        { 
            ...
            if((AppSettings.AppSetting.UserName != null) && (AppSettings.AppSetting.UserPicture != null))
            {
                AddLoginAs();
            }
        ...
        public void AddLoginAs()
        {
            ...
            this.runAsButton.Text = "Run as " + AppSettings.AppSetting.UserName;
            ...
            lastLoginUserName.Text = AppSettings.AppSetting.UserName;
            lastLoginUserName.Click += new System.EventHandler(this.logininasClicked);

            profileImage = new PictureBox();
            this.profileImage.ImageLocation = AppSettings.AppSetting.UserPicture;
